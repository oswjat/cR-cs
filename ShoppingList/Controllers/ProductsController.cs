...
namespace ShoppingList.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ShoppingListContext context)
        {
            _context = context;
        }
        ...
        {
            var shoppingListContext = _context.Product.Include(p => p.Shelf);
        ...
        {
            ViewData["ShelfId"] = new SelectList(_context.Shelfs, "Id", "Id");
            return View();
        }
